...
\includegraphics[width=1.5in]{atom.png} %sets the figure width to 1.5in
\end{figure}
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
\centering
\includegraphics[scale=0.5]{atom.png} %scales the figure down to 50% of the original size
...
{\bf Your turn:}
\begin{enumerate}
\item What happens if you change the alignment for the two columns from right, left to left, right? \item Try changing the content of the @-expression from a decimal point to something else
\item 
\end{enumerate}
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
